...
class MoonPhase
{
    ...
    public function full_moon()
    {
        return $this->get_phase(2);
    }

    public function last_quarter()
    {
        return $this->get_phase(3);
    }

    public function next_new_moon()
    {
        return $this->get_phase(4);
    }

    public function next_first_quarter()
    {
    ...
    public function next_last_quarter()
    {
